                                      ...
                                      <div class="tab-pane active" id="doc">
                                          <div class="row clearfix">
                                              ...
                                              <div class="col-lg-4 col-md-5 col-sm-12">
                                                <a href={{route('Display',$ticket->id)}}>
                                                  <div class="card">
                                                      <div class="file">
                                                            ...
                                                            <!--  <div class="hover">
                                                              ...
                                                              <div class="icon">
                                                                  <img  src="{{asset('assets/images/logo.svg')}}" width="100" height="100" alt="Aero">
                                                              </div>
                                                              <div class="file-name">
                                                                  <p class="m-b-5 text-muted">Sous agence</p>
                                                                 <!-- <p class="m-b-5 text-muted">{{$ticket->nameUser}}</p> -->

                                                                  @foreach ($ticket->Voyage as $value )
                                                                  <small>{{$value->departure}} -> {{$value->arrival}}  </small>
                                                                  <span class="date text-muted">{{$value->date}}->{{$value->heure}}</span>
                                                                  @endforeach
