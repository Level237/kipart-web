              ...
              <div class="row">
                <div class="col-sm-12 mt-5 bgWhite">
                  ...
                  <form action="{{ route('otp.verify') }}" method="POST" class="mt-5">
                    ...
                    <input name="otp[]" class="otp" type="text" oninput='digitValidate(this)'onkeyup='tabChange(5)' maxlength=1 >
                    <input name="otp[]" class="otp" type="text" oninput='digitValidate(this)'onkeyup='tabChange(6)' maxlength=1 >
                    <hr class="mt-4">
                    <button type="submit" class='btn-block mt-4 mb-4 customBtn' >Verifier</button>
                </form>
